...
var NgramIndice = /** @class */ (function () {
    ...
    NgramIndice.prototype.add = function (key, value) {
        ...
        if (Array.isArray(value)) {
            value.forEach(function (v) { return tokens.push.apply(tokens, __spread(_this.tokenizr(v))); });
        }
        else {
            tokens.push.apply(tokens, __spread(this.tokenizr(value)));
        }
    ...
    NgramIndice.prototype.postFilter = function (countResults, tokens) {
        ...
        var results = __spread(countResults.entries()).filter(function (_a) {
                        ...
                        return __awaiter(this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/, { done: false, value: result }];
                                    case 2: return [2 /*return*/, { done: true, value: undefined }];
                                }
                            });
                        });
                    }
