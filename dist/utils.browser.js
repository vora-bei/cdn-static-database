...
var restoreSharedIndices = function (_a) {
    var id = _a.id, baseUrl = _a.baseUrl, deserialize = _a.deserialize, deserializeShared = _a.deserializeShared;
    return __awaiter(void 0, void 0, void 0, function () {
        var loadChunk, load;
        return __generator(this, function (_b) {
            loadChunk = function (options) { return __awaiter(void 0, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fetch(baseUrl + "/" + id + "/chunk_" + options.id + ".json")];
                        case 1:
                            response = _a.sent();
            ...
            load = function (options) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fetch(baseUrl + "/" + id + "/index.json")];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, response.json()];
                    }
