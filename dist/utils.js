...
function combineAsyncIterable(iterable) {
    return __asyncGenerator(this, arguments, function combineAsyncIterable_1() {
        var asyncIterators, results, count, nextPromises, _a, index, result, _b, _c, _d, index, iterator;
        var e_1, _e;
...
function intersectAsyncIterable(iterable) {
    return __asyncGenerator(this, arguments, function intersectAsyncIterable_1() {
        var asyncIterators, results, count, combineResults, nextPromises, _a, index, result, combineResult, subResults, _loop_1, _b, _c, v, _d, _e, _f, index, iterator;
        var e_2, _g, e_3, _h;
        return __generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, __await(Promise.race(nextPromises))];
                case 3:
                    _a = _j.sent(), index = _a.index, result = _a.result;
                    if (!result.done) return [3 /*break*/, 4];
                    nextPromises[index] = never;
                ...
                case 4:
                    ...
                    try {
                        for (_b = (e_2 = void 0, __values(result.value)), _c = _b.next(); !_c.done; _c = _b.next()) {
                            v = _c.value;
                            _loop_1(v);
                        }
                    }
                    ...
                    return [4 /*yield*/, __await(subResults)];
                ...
                case 9:
                    try {
                        for (_d = __values(asyncIterators.entries()), _e = _d.next(); !_e.done; _e = _d.next()) {
                            _f = __read(_e.value, 2), index = _f[0], iterator = _f[1];
                            if (nextPromises[index] != never && iterator.return != null)
                                iterator.return();
                        }
                    }
